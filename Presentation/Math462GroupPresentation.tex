...
\begin{column}{0.49\linewidth}
	\begin{figure}
	\animategraphics[width=0.75\linewidth]{4}{Rosenbrock}{1}{30}
	\end{figure}	
...
\begin{column}{0.49\linewidth}
	\begin{figure}
	\animategraphics[width=0.75\linewidth]{4}{Rastrigin}{1}{25}
	\end{figure}	
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.63\linewidth}
	\begin{figure}
	\animategraphics[width=0.90\linewidth]{4}{Rheology1a}{1}{30}
	\end{figure}	
\end{column}
\end{columns}
\end{block}
...
\begin{column}{0.63\linewidth}
	\begin{figure}
	\animategraphics[width=0.90\linewidth]{4}{Rheology1b}{1}{30}
	\end{figure}	
\end{column}
\end{columns}
\end{block}
...
\begin{column}{0.63\linewidth}
	\begin{figure}
	\animategraphics[width=0.90\linewidth]{4}{Rheology2a}{1}{26}
	\end{figure}	
\end{column}
\end{columns}
\end{block}
...
\begin{column}{0.63\linewidth}
	\begin{figure}
	\animategraphics[width=0.90\linewidth]{4}{Rheology2b}{1}{30}
	\end{figure}	
\end{column}
\end{columns}
\end{block}
